...
var Mapp1 = angular.module('Mapp1');
Mapp1.service('Util', function($filter) {
...
Mapp1.service('BSServiceUtil', function(notify, ExportService, BSService, Cache) {
...
Mapp1.service('EmailService', function(notify, BSService) {
...
Mapp1.service('CommentService', function(notify, BSService) {
...
Mapp1.factory('ExportService', function($resource) {
...
Mapp1.factory('BSService', function($resource) {
...
Mapp1.service('AlertService', function(SweetAlert,notify) {
...
Mapp1.service('AppService', function(notify, BSServiceUtil, AlertService, Cache) {
